...
data_folder = './GuideNetv3_predictions_detailed/caifos_detailed_outputs'
landmarks_folder = './landmarks'
images_folder = './original_images'
sub_folders_acc = ['TP','TN','FP','FN']
# detailed_IVGs_folder = './detailed_IVGs'
import pandas as pd
from shutil import copy
from custom_utilities import *

# imgs_analysis = ['0023_BL_0.png',
# '0027_BL_3.png',
# '0105_BL_0.png',
# '0359_BL_0.png',
# '0581_BL_0.png',
...
for fctr in tqdm(list(np.arange(0.5, 1.6, 0.1))):
    ...
    data_folders = './imgs_clipped_35_and_normal_35'
    ...
    src_folder = './GuideNetv3_predictions_detailed/caifos_detailed_outputs/original_images'
    dst_folder = './imgs_clipped_35_and_normal_35/imgs'
    ...
    for idx, img_name in enumerate(tqdm(fnames_combined)):
        ...
        #     # continue
            ...
            img = Image.open(os.path.join(data_folder, images_folder,img_name))
            img = np.array(img)
            orig_img = img.copy()
            pts = pd.read_csv(os.path.join(data_folder, landmarks_folder,landmark_name),index_col=False)
