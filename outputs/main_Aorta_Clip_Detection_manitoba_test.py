...
data_folder = './GuideNetv3_predictions_detailed/manitoba_test_detailed_outputs'
...
for fctr in tqdm(list(np.arange(0.5, 1.6, 0.1))):
    ...
    src_folder = './GuideNetv3_predictions_detailed/manitoba_test_detailed_outputs/original_images'
